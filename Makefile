...
<script crossorigin="anonymous" defer="defer" type="application/javascript" src="https://github.githubassets.com/assets/notifications-global-4dc6f295cc92.js"></script>
  ...
  <meta name="request-id" content="E47E:5327:1476F97:14C030B:645958C8" data-turbo-transient="true" /><meta name="html-safe-nonce" content="8e23fd22099d5b41632171d28d67c0cc1bedf7930a1e27d26e88238761bb51b5" data-turbo-transient="true" /><meta name="visitor-payload" content="eyJyZWZlcnJlciI6bnVsbCwicmVxdWVzdF9pZCI6IkU0N0U6NTMyNzoxNDc2Rjk3OjE0QzAzMEI6NjQ1OTU4QzgiLCJ2aXNpdG9yX2lkIjoiODU4MDk1MzA2OTc0MTIwOTIyOSIsInJlZ2lvbl9lZGdlIjoiZnJhIiwicmVnaW9uX3JlbmRlciI6ImlhZCJ9" data-turbo-transient="true" /><meta name="visitor-hmac" content="c6641be4ed1fed9d11af4c044414faf191cf4cbee1a95f335b1fcf7831315dcc" data-turbo-transient="true" />
  ...
  <meta name="selected-link" value="/udacity/nd082-Azure-Cloud-DevOps-Starter-Code/blob/master/C2-AgileDevelopmentwithAzure/azure_pipelines_exercise/starter_files/Makefile" data-turbo-transient>
...
<meta name="octolytics-url" content="https://collector.github.com/github/collect" /><meta name="octolytics-actor-id" content="78079178" /><meta name="octolytics-actor-login" content="BiBa-01" /><meta name="octolytics-actor-hash" content="6f25eb06018b4845d76b51b36d61954a44330e3bf7cd1aeb4dfb7b629cc52d4b" />
  ...
  <meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-turbo-transient="true" />
    ...
    <meta name="user-login" content="BiBa-01">
  ...
  <link rel="sudo-modal" href="/sessions/sudo_modal">
    ...
    <meta name="apple-itunes-app" content="app-id=1477376905" />
      ...
      <link rel="shared-web-socket" href="wss://alive.github.com/_sockets/u/78079178/ws?session=eyJ2IjoiVjMiLCJ1Ijo3ODA3OTE3OCwicyI6MTA5MzU5MzQ3MywiYyI6MzA0MTM3ODUzMSwidCI6MTY4MzU3NzA0NX0=--fef33c5b104686f2a1e3004803e5f1489aa9925f0f7937b23ca2f08a54117b75" data-refresh-url="/_alive" data-session-id="19e801575d8996c6ca55d7d052389be5bf6e45ed9fd43459fe81e3d8a7102ef3">
...
<div class="flash flash-full   {{ className }}">
  <div class="px-2" >
    ...
    <notification-shelf-watcher data-base-url="https://github.com/notifications/beta/shelf" data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6NzgwNzkxNzgiLCJ0IjoxNjgzNTc3MDQ1fQ==--bc574b22f8066dd1c150c72ba5cad0ecd560c34e77b19ae55928e5b683ddd024" data-view-component="true" class="js-socket-channel"></notification-shelf-watcher>
...
>
  ...
  <details-dialog class="command-palette-details-dialog d-flex flex-column flex-justify-center height-fit" aria-label="command palette">
    <command-palette
      ...
      return-to=/udacity/nd082-Azure-Cloud-DevOps-Starter-Code/blob/master/C2-AgileDevelopmentwithAzure/azure_pipelines_exercise/starter_files/Makefile
      user-id="78079178"
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <command-palette-scope >
          <div data-target="command-palette-scope.placeholder" hidden class="color-fg-subtle">/&nbsp;&nbsp;<span class="text-semibold color-fg-default">...</span>&nbsp;&nbsp;/&nbsp;&nbsp;</div>
              ...
              <command-palette-token
                data-text="nd082-Azure-Cloud-DevOps-Starter-Code"
                data-id="MDEwOlJlcG9zaXRvcnkyNzI4NDAyMjU="
                data-type="repository"
                data-value="nd082-Azure-Cloud-DevOps-Starter-Code"
                data-targets="command-palette-scope.tokens"
                class="color-fg-default text-semibold"
                style="white-space:nowrap;line-height:20px;"
                >nd082-Azure-Cloud...<span class="color-fg-subtle text-normal">&nbsp;&nbsp;/&nbsp;&nbsp;</span></command-palette-token>
        </command-palette-scope>
...
</button>    <tool-tip id="tooltip-3efdad86-969b-40c7-b828-735203e634f3" for="command-palette-clear-button" data-direction="w" data-type="label" data-view-component="true" class="sr-only position-absolute">Clear Command Palette</tool-tip>
</div>
      </command-palette-input>

      <command-palette-page-stack
        data-default-scope-id="MDEwOlJlcG9zaXRvcnkyNzI4NDAyMjU="
    ...
    <path d="M6.457 1.047c.659-1.234 2.427-1.234 3.086 0l6.082 11.378A1.75 1.75 0 0 1 14.082 15H1.918a1.75 1.75 0 0 1-1.543-2.575Zm1.763.707a.25.25 0 0 0-.44 0L1.698 13.132a.25.25 0 0 0 .22.368h12.164a.25.25 0 0 0 .22-.368Zm.53 3.996v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 1.5 0ZM9 11a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path>
        ...
        <div hidden>
            ...
            <command-palette-page
              data-page-title="nd082-Azure-Cloud-DevOps-Starter-Code"
              data-scope-id="MDEwOlJlcG9zaXRvcnkyNzI4NDAyMjU="
  ...
  <div class="auth-form-body mb-4" style="padding: 30px">
    ...
    <div class="d-flex flex-column flex-auto mb-4">
      <div class="d-flex flex-justify-center mb-2">
        <img img_class="avatar" src="https://avatars.githubusercontent.com/u/78079178?s=100&amp;v=4" width="50" height="50" alt="@BiBa-01" class=" avatar-user" />
      </div>
      <div class="text-center">
        <h3 class="color-fg-default lh-condensed">Birte</h3>
        <h4 class="color-fg-muted lh-condensed text-normal">BiBa-01</h4>
      </div>
    </div>
    ...
    <div class="text-left mb-3">
      <p class="f4 text-normal">
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="inline-form" data-turbo="false" action="/settings/two_factor_checkup/delay" accept-charset="UTF-8" method="post"><input type="hidden" name="_method" value="put" autocomplete="off" /><input type="hidden" name="authenticity_token" value="RPBWCiJfMYAs6XWg4aOHdJpXNUEMob2bBajWXelTmSeXAr8zukVXAA6QBaHayfB83w_mz9D9_nLeJzrBjbuVWg" />
            You can choose to
